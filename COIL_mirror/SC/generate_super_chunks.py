...
TASK 005 — Zero Coding Mode sync engine
...
def generate_super_chunks():
    ...
    last_size = num_total % SUPER_PER_BATCH
...
# ─── Phase 3: Upload (curl, correct server headers) ─────────────────────────
...
if __name__ == "__main__":
    ...
    if phase in ("all", "upload"):
        ...
        bl = upload_super_chunks(chip["super_chunks"], batch_log_path)
